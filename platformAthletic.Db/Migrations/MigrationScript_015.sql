...
GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__tmp_ms_xx__MaxCo__1B9317B3];
...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [DF__tmp_ms_xx__Gende__73852659];
...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [DF__tmp_ms_xx__IsDel__74794A92];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Team] ([ID], [UserID], [Name], [LogoPath], [StateID], [SchoolID], [PrimaryColor], [SecondaryColor], [SBCControl], [MaxCount])
        SELECT   [ID],
                 [UserID],
                 [Name],
                 [LogoPath],
