...
GO
PRINT N'Rename refactoring operation with key c93baa6d-a556-4de3-8b5f-4225d4d93b3b is skipped, element [dbo].[Contact].[Id] (SqlSimpleColumn) will not be renamed to ID';
...
GO
PRINT N'Starting rebuilding table [dbo].[About]...';
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_FieldPosition] ([ID], [SportID], [Code], [Name])
        SELECT   [ID],
                 [SportID],
                 [Code],
                 [Name]
...
CREATE TABLE [dbo].[tmp_ms_xx_Group] (
    ...
    [TeamID]    INT            NOT NULL,
    [Name]      NVARCHAR (500) NOT NULL,
    [IsPhantom] BIT            DEFAULT 0 NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Group] ([ID], [TeamID], [Name], [IsPhantom])
        SELECT   [ID],
                 [TeamID],
                 [Name],
                 [IsPhantom]
...
GO
PRINT N'Starting rebuilding table [dbo].[Level]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Level] (
    [ID]   INT           IDENTITY (1, 1) NOT NULL,
    [Name] NVARCHAR (50) NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Level] PRIMARY KEY CLUSTERED ([ID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Level])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Level] ON;
        INSERT INTO [dbo].[tmp_ms_xx_Level] ([ID], [Name])
        SELECT   [ID],
                 [Name]
        FROM     [dbo].[Level]
        ORDER BY [ID] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Level] OFF;
    END

DROP TABLE [dbo].[Level];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Level]', N'Level';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_Level]', N'PK_Level', N'OBJECT';
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_PillarType] ([ID], [Name], [Measure], [TextAbove], [VideoUrl], [VideoCode], [Preview], [Text], [Type], [Placeholder])
        SELECT   [ID],
                 [Name],
                 [Measure],
                 [TextAbove],
...
CREATE TABLE [dbo].[tmp_ms_xx_Post] (
    ...
    [Text]           NVARCHAR (MAX) NOT NULL,
    [AddedDate]      DATETIME       NOT NULL,
    [TitleImagePath] NVARCHAR (150) DEFAULT '' NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Post] ([ID], [UserID], [Header], [Text], [AddedDate], [TitleImagePath], [Promoted], [IsVideo], [VideoUrl], [VideoCode], [VideoPreview], [CountOfView])
        SELECT   [ID],
                 [UserID],
                 [Header],
                 [Text],
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_SBCValue] ([ID], [UserID], [TeamID], [AddedDate], [Squat], [Bench], [Clean])
        SELECT   [ID],
                 [UserID],
                 [TeamID],
                 [AddedDate],
...
GO
PRINT N'Starting rebuilding table [dbo].[Sport]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Sport] (
    [ID]   INT           IDENTITY (1, 1) NOT NULL,
    [Name] NVARCHAR (50) NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Sport] PRIMARY KEY CLUSTERED ([ID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Sport])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Sport] ON;
        INSERT INTO [dbo].[tmp_ms_xx_Sport] ([ID], [Name])
        SELECT   [ID],
                 [Name]
        FROM     [dbo].[Sport]
        ORDER BY [ID] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Sport] OFF;
    END

DROP TABLE [dbo].[Sport];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Sport]', N'Sport';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_Sport]', N'PK_Sport', N'OBJECT';
...
CREATE TABLE [dbo].[tmp_ms_xx_Team] (
    ...
    [SBCAttendance]  INT            DEFAULT 0 NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Team] ([ID], [UserID], [Name], [LogoPath], [StateID], [PrimaryColor], [SecondaryColor], [SBCControl], [SBCAttendance], [MaxCount])
        SELECT   [ID],
                 [UserID],
                 [Name],
                 [LogoPath],
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_User] ([ID], [IndividualStateID], [Email], [Password], [AddedDate], [ActivatedDate], [ActivatedLink], [LastVisitDate], [AvatarPath], [FirstName], [LastName], [PaidTill], [PhoneNumber], [PlayerOfTeamID], [AssistantOfTeamID], [GroupID], [VisitGettingStartedPage], [Year], [Squat], [Bench], [Clean], [Height], [Weight], [BodyFat], [_40YardDash], [Vertical], [_3Cone], [TDrill], [PrimaryColor], [SecondaryColor], [LoginInfoSent], [AttendanceStartDate], [ProgressStartDate], [Birthday], [Gender], [LevelID], [GradYear], [PublicLevel], [Mode], [IsDeleted], [IsPhantom], [Todo], [TutorialStep])
        SELECT   [ID],
                 [IndividualStateID],
                 [Email],
                 [Password],
...
GO
PRINT N'Starting rebuilding table [dbo].[UserFieldPosition]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_UserFieldPosition] (
    [ID]              INT IDENTITY (1, 1) NOT NULL,
    [SportID]         INT NOT NULL,
    [UserID]          INT NOT NULL,
    [FieldPositionID] INT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_UserFieldPosition] PRIMARY KEY CLUSTERED ([ID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[UserFieldPosition])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_UserFieldPosition] ON;
        INSERT INTO [dbo].[tmp_ms_xx_UserFieldPosition] ([ID], [SportID], [UserID], [FieldPositionID])
        SELECT   [ID],
                 [SportID],
                 [UserID],
                 [FieldPositionID]
        FROM     [dbo].[UserFieldPosition]
        ORDER BY [ID] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_UserFieldPosition] OFF;
    END

DROP TABLE [dbo].[UserFieldPosition];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_UserFieldPosition]', N'UserFieldPosition';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_UserFieldPosition]', N'PK_UserFieldPosition', N'OBJECT';
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_UserSeason] ([ID], [SeasonID], [UserID], [GroupID], [StartDay])
        SELECT   [ID],
                 [SeasonID],
                 [UserID],
                 [GroupID],
...
GO
PRINT N'Starting rebuilding table [dbo].[UserVideo]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_UserVideo] (
    [ID]        INT            IDENTITY (1, 1) NOT NULL,
    [UserID]    INT            NOT NULL,
    [Header]    NVARCHAR (500) NOT NULL,
    ...
    [Preview]   NVARCHAR (150) DEFAULT '' NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_UserVideo] PRIMARY KEY CLUSTERED ([ID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[UserVideo])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_UserVideo] ON;
        INSERT INTO [dbo].[tmp_ms_xx_UserVideo] ([ID], [UserID], [Header], [VideoUrl], [VideoCode], [Preview])
        SELECT   [ID],
                 [UserID],
                 [Header],
                 [VideoUrl],
        ...
        FROM     [dbo].[UserVideo]
        ORDER BY [ID] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_UserVideo] OFF;
    END

DROP TABLE [dbo].[UserVideo];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_UserVideo]', N'UserVideo';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_UserVideo]', N'PK_UserVideo', N'OBJECT';
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Video] ([ID], [TrainingID], [Header], [Text], [VideoUrl], [VideoCode], [Preview])
        SELECT   [ID],
                 [TrainingID],
                 [Header],
                 [Text],
...
GO
PRINT N'Creating [dbo].[FK_User_IndividualState]...';


GO
ALTER TABLE [dbo].[User] WITH NOCHECK
    ADD CONSTRAINT [FK_User_IndividualState] FOREIGN KEY ([IndividualStateID]) REFERENCES [dbo].[State] ([ID]);
...
GO
ALTER TABLE [dbo].[UserSeason] WITH NOCHECK
    ADD CONSTRAINT [FK_UserSeason_Group] FOREIGN KEY ([GroupID]) REFERENCES [dbo].[Group] ([ID]);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c93baa6d-a556-4de3-8b5f-4225d4d93b3b')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c93baa6d-a556-4de3-8b5f-4225d4d93b3b')
...
ALTER TABLE [dbo].[User] WITH CHECK CHECK CONSTRAINT [FK_User_IndividualState];
