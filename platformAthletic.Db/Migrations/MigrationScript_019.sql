...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [DF__tmp_ms_xx__Gende__3429BB53];
...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [DF__tmp_ms_xx__Publi__351DDF8C];
...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [DF__tmp_ms_xx__IsDel__361203C5];
...
GO
PRINT N'Dropping [dbo].[FK_User_Team2]...';


GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [FK_User_Team2];


GO
PRINT N'Dropping [dbo].[FK_User_IndividualState]...';


GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [FK_User_IndividualState];
