...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [DF__tmp_ms_xx__Gende__0E04126B];
...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [DF__tmp_ms_xx__Publi__0EF836A4];
...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [DF__tmp_ms_xx__IsDel__0FEC5ADD];
