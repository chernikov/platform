...
{
    public class SearchSchoolLeaderboardFilter
    {
        public static void CutSearchCriteria(SearchSchoolLeaderboard Search, IQueryable<User> users, bool preFilter = false)
        {
